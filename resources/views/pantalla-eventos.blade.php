...
<body>
    <div class="container">
        <div class="header">
            <a href="{{ route('moduloeventos.menu') }}" class="back-button">Regresar</a>
        ...
        <div class="options-grid">
            <a href="{{ route('eventos.index') }}" class="option">
            ...
            <a href="{{ route('eventos.actualizar') }}" class="option">
                <div class="option-icon">
                    <i class="fas fa-edit"></i>
                </div>
                <span class="option-text">Actualizar Evento</span>
            </a>
            ...
            <a href="{{ route('eventos.index') }}" class="option">
                ...
                <span class="option-text">Eliminar Evento</span>
            </a>
        </div>
    </div>
</body>
