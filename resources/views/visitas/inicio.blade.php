...
<body>
    <div class="container">
        <div class="header">
            ...
            <h1 class="title">MÓDULO DE VISITAS</h1>
            <div style="width: 100px;"></div>
        </div>

        <div class="image-box">
            <img src="{{ asset('visitas.png') }}" alt="Imagen Visitas">
        </div>

        <h2 class="text-xl font-semibold text-center mb-6">ÁREAS DISPONIBLES</h2>

        <div class="options-grid">
            <a href="{{ route('visitas.index') }}" class="option">
                <div class="option-icon"><i class="fas fa-eye"></i></div>
                <span class="option-text">Ver visitas</span>
            </a>

            <a href="{{ route('visitas.index', ['crear' => 1]) }}" class="option">
                <div class="option-icon"><i class="fas fa-plus"></i></div>
                <span class="option-text">Insertar visita</span>
            </a>
